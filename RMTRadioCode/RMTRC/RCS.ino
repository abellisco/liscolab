...
static const CLI_Command_Definition_t xrcsxmitCommand =
{
  ...
  "example transmit the value 23456 (decimal) using RC-Switch: rcsxmit 23456 \r\n",
  prvRCSXmitCommand,
  1
};
...
BaseType_t prvRCScfgCommand( char *pcWriteBuffer, size_t xWriteBufferLen, const char *pcCommandString ) {
  ...
  sprintf(pcWriteBuffer, "\r\nRCSwitch parameters changed: Protocol %d, Pulselength %d, Repeat n %d ", uvalue1, uvalue2, uvalue3 );
  return pdFALSE;
}
